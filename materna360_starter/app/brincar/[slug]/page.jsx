    ...
    <main className="mx-auto max-w-md px-4 py-6 space-y-4">
      ...
      <GlassCard className="p-4">
        ...
        <div className="mt-2 flex flex-wrap gap-2 text-[11px]">
          ...
          {(item.age_min || item.age_max) && <span className="px-2 py-0.5 rounded-full bg-brand-secondary/60">
      ...
      <GlassCard className="p-4">
        ...
        <p className="mt-2 text-brand-slate">
          (Em breve) conteúdo detalhado da atividade com objetivo, materiais e passos.
        </p>
      </GlassCard>
