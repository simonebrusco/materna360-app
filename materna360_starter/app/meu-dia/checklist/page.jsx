...
import { handleChecklistAward } from "../../../lib/checklistAwards.js"; // ✅ novo
    ...
    <main className="max-w-5xl mx-auto px-5 py-6">
      ...
      <section className="space-y-2">
        {initialDefs.map((it) => {
          ...
          // handler que sabe se vai marcar agora
          const onToggle = () => {
            const willCheck = !checked; // estado após o clique
            toggleToday(it.id);
            // dispara eventos (win + changed) conforme regra
            ...
            >
              <div className="flex items-center gap-3">
                <input
                  type="checkbox"
                  checked={checked}
                  onChange={onToggle}                              {/* ✅ agora aciona gamificação */}
